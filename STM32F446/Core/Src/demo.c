...
static void slider_event_cb(lv_obj_t * slider, lv_event_t event)
{
    ...
    if(event == LV_EVENT_VALUE_CHANGED)
    {
    	...
    	set = (float)(lv_slider_get_value(slider));
    	pid->setpoint = &set;
...
static void slider2_event_cb(lv_obj_t * slider, lv_event_t event)
{
    ...
    if(event == LV_EVENT_VALUE_CHANGED)
    {
    	...
    	set1 = (float)(lv_slider_get_value(slider));
    	pid1->setpoint = &set1;
...
void demo_create(void)
{
    ...
    needle_colors[1] = LV_COLOR_WHITE;
    ...
    lv_obj_t * tab4 = lv_tabview_add_tab(tv, "MotorTop");
    lv_obj_t * tab5 = lv_tabview_add_tab(tv, "MotorBot");
    lv_obj_t * tab6 = lv_tabview_add_tab(tv, "Status");

    gauge1 = lv_gauge_create(tab4,NULL);
    ...
    lv_obj_t * slider1 = lv_slider_create(tab4,NULL);
    ...
    lv_obj_t * slider2 = lv_slider_create(tab5,slider1);
    lv_obj_set_event_cb(slider2, slider2_event_cb);




    lv_obj_t * label1 = lv_label_create(tab4,NULL);
    lv_label_set_text(label1,"Setpoint");
    lv_obj_align(label1, slider1,LV_ALIGN_OUT_BOTTOM_MID,0,20);

    lv_obj_t * label2 = lv_label_create(tab5,label1);
    lv_obj_align(label2, slider2,LV_ALIGN_OUT_BOTTOM_MID,0,20);

    lv_obj_t *sw1 = lv_sw_create(tab4,NULL);

    gauge2 = lv_gauge_create(tab5,gauge1);

    /*TAB6 -- STATUS*/
    lv_obj_t * text_Speed1 = lv_label_create(tab6,NULL);
    lv_label_set_text(text_Speed1,"Motor1: ");
    lv_obj_set_pos(text_Speed1,30,20);

    lv_obj_t * text_Speed2 = lv_label_create(tab6,NULL);
    lv_label_set_text(text_Speed2,"Motor2: ");
    lv_obj_align(text_Speed2,text_Speed1,"LV_ALIGN_OUT_LEFT_BOTTOM",0,20);

    speed1 = lv_label_create(tab6,NULL);
    lv_label_set_text(speed1,"000000 rpm");
    lv_obj_align(speed1,text_Speed1,LV_ALIGN_OUT_RIGHT_MID,10,0);
    speed2 = lv_label_create(tab6,speed1);
    lv_obj_align(speed2,text_Speed2,LV_ALIGN_OUT_RIGHT_MID,10,0);
